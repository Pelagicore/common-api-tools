 ...
 * Author: Jacques Guillou (jacques.guillou@pelagicore.com)
...
class FInterfaceServiceAbstractGenerator {
    ...
    def String getTypeName(FTypedElement _element, FModelElement _source) {
    	getTypeName(_element, _source, false)
	}
...
«««                return «method.elementName»(«method.generateArgumentsToStubOldStyle»);
«««            }
